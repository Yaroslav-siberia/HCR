...
from DetectingWordsNN.src.coding import encode
from DetectingWordsNN.src.utils import compute_scale_down, prob_true
...
class DataLoaderImgFile:
    ...
    def __init__(self, root_dir, input_size, device, max_side_len=1024):
        ...
        self.fn_imgs += root_dir.files('*.png')
        self.fn_imgs += root_dir.files('*.jpeg')
        self.fn_imgs += root_dir.files('*.bmp ')
        self.input_size = input_size
        self.device = device
