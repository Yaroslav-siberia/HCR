...
def get_img_size(line_mode: bool = False) -> Tuple[int, int]:
    """получение размера изображдения"""
    if line_mode:
...
def train(model: Model,
    ...
    while True:
        ...
        # sостановка обучения если результат не улучшился за early_stopping итераций подряд
...
def main():
    ...
    parser.add_argument('--decoder', choices=['bestpath', 'beamsearch'], default='bestpath')
