...
def scaner(file_list):
    ...
    for file in file_list:
        ...
        try:
            ...
            result_name = args_image.replace('original','scaned')
            cv2.imwrite(result_name,scanBW)
...
file_list = get_img_files('/home/ysiberia/PycharmProjects/HandWrittenTR/DetectingWords/input')
scaner(file_list)